...
# Specifically selelcted out the estimates and both confidence intervals per city, state. Additonally, reordering the 'city_state' variable by the 'estimate' variable.
city_state_output = output %>%
  select(city_state, estimate, conf.low, conf.high, p.value) %>%
  mutate(city_state = forcats::fct_reorder(city_state, estimate))

# Making of the boxplot with inclusion of error bars corresponding to low and high confidencce intervals.
city_state_output %>% 
