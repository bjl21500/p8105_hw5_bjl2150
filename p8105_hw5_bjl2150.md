...
mutate(total\_homicides = )

separate(disposition, into = C("Closed by arrest", "Closed without arrest", "Open/No arrest") mutate(Closed = filter(disposition == "Closed without arrest"))

       %>%

mutate(unsolved\_homicides = recode(disposition != "Close by arrest"))
